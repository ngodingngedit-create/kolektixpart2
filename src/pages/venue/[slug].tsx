                    ...
                    <div className="flex flex-col gap-2 px-4 py-2.5 max-w-lg mx-auto">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                className="w-[40px] h-[40px] flex items-center justify-center shrink-0 rounded-xl text-[#194e9e] border border-[#194e9e]/20 bg-blue-50/50 hover:bg-blue-50 active:scale-95 transition-all"
                            >
